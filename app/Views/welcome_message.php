...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= base_url() ?>sobrenos" target="_blank">Sobre nós</a></li>
            <li class="menu-item hidden"><a href="/faleconosco" target="_blank">Fale Conosco</a></li>
    ...
    <div class="heroe">
        ...
        <h1>Seja bem vindo ao CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
